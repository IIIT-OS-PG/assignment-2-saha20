...
string create_userid(char *ptr)
{
	...
	FILE *fopenfd = fopen("/home/shubhankar/Desktop/password.txt", "ab");
...
string login(char *ptr)
{
	...
	password_file.open("/home/shubhankar/Desktop/password.txt");
...
{ 
	...
	//************** SEARCH IN TRACKER FILE *************************************
		string line;
			...
			tracker_file.open("/home/shubhankar/Desktop/tracker.txt");
...
void upload(char *ptr)
{
	FILE *fopenfd = fopen("/home/shubhankar/Desktop/tracker.txt", "ab");
...
int main()
{
	...
	while(1)
	{
		...
		const char *file_path = "/home/shubhankar/Desktop/tracker.txt" ;
